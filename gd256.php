...
function pick_categories(array $item): array {
    if (!isset($item['Category']) || !is_array($item['Category'])) return [];
...
foreach ($items as $item) {
    ...
    $categories = pick_categories($item);
...
echo json_encode([
    ...
    "source_url" => $sourceUrl,
    "games_dir" => $gamesDir,
    "shard_scheme" => "first_2_md5_chars",
