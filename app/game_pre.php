...
$sandbox = str_contains($iframeSrc, 'html5.g55.co') ? '' : ' sandbox="allow-scripts allow-same-origin allow-pointer-lock"';
...
if ($pageIndex !== -1) {
    ...
    while (count($similar) < 4 && (($pageIndex - $radius) >= 0 || ($pageIndex + $radius) < $max)) {
