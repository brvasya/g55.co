...
<iframe<?php echo str_ends_with(parse_url($iframeSrc, PHP_URL_HOST), 'g55.co') ? '' : ' sandbox="allow-scripts allow-same-origin allow-pointer-lock"'; ?> src="<?php echo h($iframeSrc); ?>"></iframe>
</div>
